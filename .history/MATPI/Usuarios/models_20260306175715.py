...
class Usuario(models.Model):
    ...
    id                  = models.CharField('Identificación', max_length=16, primary_key=True)
    ...
    experiencia_laboral = models.CharField('Experiencia Laboral',  max_length=15,  blank=True, null=True)
